...
class OrderTest {
    ...
    @Test
    void givenPlacedOrder_whenMarkAsReady_shouldChangeToReady() {
    ...
    @Test
    void givenPlacedOrder_whenTryToMarkAsReady_shouldGenerateException() {
    ...
    @Test
    void givenDraftOrderAndDeliveryDateInThePast_whenChangeShipping_shouldGenerateException() {
    ...
    @Test
    void givenOutOfStockProduct_whenTryToAddToAnOrder_shouldGenerateException() {
        Order order = Order.draft(new CustomerId());
    ...
    @Test
    void givenAPlacedOrder_whenTryToEdit_shouldGenerateException() {
        Order order = OrderTestDataBuilder.anOrder().build();
